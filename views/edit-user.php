        ...
        <form action="../actions/edit-user.php" method="post" enctype="multipart/form-data">
            <div class="row justify-content-center">
                ...
                <?php
                        ...
                        <input type="file" name="photo" id="photo" class="form-control mt-2" access="image/*"> <!--access は document ect変えられる -->
                </div>
            </div>
          ...
          <div class="text-end">
            ...
            <button type="submit" class="btn btn-warning btn-small px-5">Save</button>
          </div>
